...
(function () {
    ...
    M = function (a) {
        if (!D || a) {
            ...
            ia || sa();
            if (p && P()) {
                (a = window.location.href) && 0 > a.toLowerCase().indexOf("http:") && 0 > a.toLowerCase().indexOf("https:") && (O("The scan applet does *NOT* work in local HTML files. Please host this page on localhost or any other servers and access it using http:// or https://.", !0), alert("The scan applet does *NOT* work in local HTML files. Please host this page on localhost or any other servers and access it using http:// or https://."));
    ...
    function S(a) {
        if (ea)
            if (w) y = void 0, w.close();
                ...
                a || (u = void 0, Ia += 1);
                a = null != window.location.href && "http:" == window.location.href.substr(0, 5) ? "ws://127.0.0.1" : "wss://local.scannerjs.com";
